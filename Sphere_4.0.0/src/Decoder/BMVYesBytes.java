...
public class BMVYesBytes implements Potocol {
...
//        //.Bin generator
//        byte[] allBytes;
//        allBytes = message.array();
//        try {
//            Files.write(Paths.get(new String(seqNum + "") + "_" + new String((char) type + "") + ".bin"), allBytes);
//        } catch (Exception e) {
//            System.out.println("Error while .bin generating " + e);
//        }
//        //FIN .Bin generator
        switch (type) {
