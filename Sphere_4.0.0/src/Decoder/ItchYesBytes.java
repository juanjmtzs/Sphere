...
public class ItchYesBytes implements Potocol {
        ...
        switch (type) {
            case add_order:
                ...
                try {
                    ...
                    jsonSonstructor = jsonSonstructor + "\"" + message.remaining() + " Bytes" + "\":\"";
                    for (int i = 0; i < message.remaining(); i++) {
            ...
            case stock_directory:
                ...
                try {
                    ...
                    DefaultTableModel model = (DefaultTableModel) OUCHMain.orderbookTable.getModel();
            ...
            case glimpse_snapshot:
                ...
                ITCHSoupBinTCPYesBytes.gapFilled();
                break;
            case reference_price:
                count_reference_price++;
                boolean isAPrice = false;
                Object id = 0;
                BigInteger price;
                try {
                    ...
                    if (isAPrice) {
                        for (int x = 0; x < OUCHMain.orderbookTable.getRowCount(); x++) {

                            if (OUCHMain.orderbookTable.getValueAt(x, 0).equals(id) == true) {
                                OUCHMain.orderbookTable.setValueAt(price, x, 4);
                            }
