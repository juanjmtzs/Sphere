...
public class ITCHSoupBinTCPYesBytes {
    ...
    public ITCHSoupBinTCPYesBytes(String username, String password, String session, String host, int port, long sequenceNumber, Decoder.Potocol protocol) throws IOException {
    ...
    private static void sendBuffer(ByteBuffer b) throws IOException {
    ...
    public static void StartHandling(String[] args) throws IOException, UnsupportedLookAndFeelException {
        ...
        try {
            ...
            final ITCHSoupBinTCPYesBytes s = new ITCHSoupBinTCPYesBytes(args[0], args[1], args[2], args[3], Integer.parseInt(args[4]), Long.parseLong(args[5]), new Decoder.ItchYesBytes());
