...
public class OUCHSoupBinTCPNoBytes {
    ...
    public OUCHSoupBinTCPNoBytes(String username, String password, String session, String host, int port, long sequenceNumber, Decoder.Potocol protocol) throws IOException {
            ...
            switch (type) {
                case PacketType.sequenced_data_type:
                    ...
                    OUCHMain.Update.setText(""
                            ...
                            + ".::RECEIVED MESSAGES::." + "\n"
                            + "     System Events(S):  " + Decoder.OuchNoBytes.count_system_event + "\n"
                            + "     Accepted Message (A):  " + Decoder.OuchNoBytes.count_accepted_message + "\n"
                            + "     Replaced Orders (U):  " + Decoder.OuchNoBytes.count_replaced_order + "\n"
                            + "     Cancelled Orders(C):  " + Decoder.OuchNoBytes.count_cancelled_order + "\n"
                            + "     Executed Order (E):  " + Decoder.OuchNoBytes.count_executed_order + "\n"
                            + "     Broken Trades (B):  " + Decoder.OuchNoBytes.count_broken_trade + "\n"
                            + "     Rejected Messages (J):  " + Decoder.OuchNoBytes.count_rejected_message
                            + "\n");
    ...
    public static void StartHandling(String[] args) throws IOException, UnsupportedLookAndFeelException {
        ...
        Decoder.OuchNoBytes.count_accepted_message = 0;
        Decoder.OuchNoBytes.count_broken_trade = 0;
        count_cancel_order = 0;
        Decoder.OuchNoBytes.count_cancelled_order = 0;
        count_enter_order = 0;
        Decoder.OuchNoBytes.count_executed_order = 0;
        Decoder.OuchNoBytes.count_rejected_message = 0;
        count_replace_order = 0;
        Decoder.OuchNoBytes.count_replaced_order = 0;
        Decoder.OuchNoBytes.count_system_event = 0;
        if (args.length != 7) {
            args = new String[6];
        ...
        try {
            ...
            final OUCHSoupBinTCPNoBytes s = new OUCHSoupBinTCPNoBytes(args[0], args[1], args[2], args[3], Integer.parseInt(args[4]), Long.parseLong(args[5]), new Decoder.OuchNoBytes());
